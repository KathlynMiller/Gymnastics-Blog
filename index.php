...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Gymnastics Blog</a>
            </div>
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Gymnastics Blog</h2>
                    <h3 class="section-subheading text-muted">These are gymnasts who competed at the Rio Olympics</h3>
     ...
     <div class="carousel-inner" role="listbox">
      ...
      <img src="images/gabby2.jpg" alt="pic1" height="350px" width="450px">
      <div class="carousel-caption">

      </div>
    </div>
    <div class="item">
      <img src="images/laurie2.jpg" alt="pic2" height="350px" width="450px">
      <div class="carousel-caption">

      </div>
    </div>
    <div class="item">
      <img src="images/simone2.jpg" alt="pic3" height="350px" width="450px">
      <div class="carousel-caption">
